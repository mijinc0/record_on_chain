...
RSpec.describe RecordOnChain::Controller::NemController do
  ...
  let( :sender_keypair ){ Nem::Keypair.new("51f42e592e4bc527f890a5a4b1fad95c0f22c03662f728edf2f7d75d640205b2") }
  ...
  describe "#send_transfer_tx" do
    context "return nomal responses" do
      ...
      it{ expect( nem_controller.send_transfer_tx( recipient, "message", sender_keypair ) ).to eq expected }
    end
